...
## Project Structure
    ...
    ├── abd_testcreateapp1_7  # Django project configurations
...
1. Clone this repo and `cd abd_testcreateapp1_7`
...
2. Clone this repo and `cd abd_testcreateapp1_7`
